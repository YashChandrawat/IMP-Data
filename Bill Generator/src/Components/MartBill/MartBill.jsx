...
import MartBillTemplate1 from "./Templates/MartBillTemplate1";
import {
  heading,
  labelClass,
  mainContainer,
...
const MartBill = () => {
  ...
  const renderTemplate = () => {
    switch (selectedTemplate) {
      case "template1":
        return <MartBillTemplate1 template1={true} />;
      case "template2":
        return <MartBillTemplate1 template2={true} />;
  ...
  return (
    <div className={`${mainContainer}`}>
      <h2 className={`${heading}`}>Mart Bill</h2>
