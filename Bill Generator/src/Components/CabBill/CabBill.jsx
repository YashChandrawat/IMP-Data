...
import CabBillTemplate from "./Templates/CabBillTemplate";
import {
  heading,
  labelClass,
  mainContainer,
...
const CabBill = () => {
  ...
  const renderTemplate = () => {
    switch (selectedTemplate) {
      case "template1":
        return <CabBillTemplate template1={true} />;
      case "template2":
        return <CabBillTemplate template2={true} />;
  ...
  return (
    <div className={`${mainContainer}`}>
      <h2 className={`${heading}`}>Cab Bill</h2>
